...
// Chuyển thành object có key là quốc gia
const cityOptionsByCountry = {
  ...
  "Nhật Bản": [], // Chưa có thành phố học bổng
  Đức: ["Munich, Germany", "Germany"],
  "Hàn Quốc": [], // Chưa có thành phố học bổng
...
const RegisterForm = () => {
  ...
  const handleChange = (e) => {
    ...
    // Nếu đổi quốc gia, reset lại city
    if (name === "country") {
      setFormData({
        ...formData,
        [name]: value,
  ...
  // Lấy danh sách thành phố theo quốc gia đã chọn
